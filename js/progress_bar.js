...
function scrollProgressBar() {
  ...
  document.addEventListener("scroll", function() {
    var toChange = document.querySelector("aside:first-child .cont:not(.filters .cont)") || document.getElementById("config") || document.querySelector(".filters .cont");
    if (toChange.classList.contains("cont")) {
      var limit = 90;
    }
    else if (toChange.classList.contains("config")){
      var limit = 30;
    }
    else {
      var limit = 40;
